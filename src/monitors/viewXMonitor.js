...
viewXMonitor.prototype.run = function(Client)
{
...
viewXMonitor.prototype.analyzeResponse = function(Client, exports, name) {
...
viewXMonitor.prototype.handleExpress = function(Client, exports, name) {
...
module.exports = new viewXMonitor;